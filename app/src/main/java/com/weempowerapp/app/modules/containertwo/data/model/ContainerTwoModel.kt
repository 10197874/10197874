package com.weempowerapp.app.modules.containertwo.`data`.model

import com.weempowerapp.app.R
import com.weempowerapp.app.appcomponents.di.MyApp
import kotlin.String

data class ContainerTwoModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtCreatean: String? = MyApp.getInstance().resources.getString(R.string.msg_create_an_account)
  ,
  /**
   * TODO Replace with dynamic value
   */
